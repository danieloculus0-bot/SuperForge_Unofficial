...
ENTITY_RELEVANCE={
 "job":{"job_tracker","purchase_orders","inventory","clocking","quality","pm","vault","ezfair","ppap","planning","integrations","bean","audit"},
 ...
 "quality_record":{"quality","job_tracker","purchase_orders","inventory","pm","vault","ezfair","ppap","suppliers","bean","audit"},
 "machine":{"pm","job_tracker","quality","planning","bean","audit"},
 "document":{"vault","ezfair","quality","job_tracker","quoting","integrations","audit"},
 "part":{"job_tracker","quality","vault","ezfair","ppap","inventory","quoting","suppliers","bean","audit"},
 "supplier":{"suppliers","purchase_orders","inventory","quality","quoting","bean","audit"},
 "fai":{"ezfair","quality","job_tracker","vault","ppap","bean","audit"},
}

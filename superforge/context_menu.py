...
ENTITY_RELEVANCE={
 ...
 "supplier":{"suppliers","purchase_orders","inventory","quality","ez_methods","quoting","bean","audit"},
 ...
 "method_dependency":{"ez_methods","purchase_orders","inventory","job_tracker","quality","suppliers","ezfair","bean","audit"},
}
